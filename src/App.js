    ...
    <Router>
      <div className="bg-secondary-subtle text-emphasis-primary p-3 border border-5">
        ...
        >
          ...
          <Route
            path="/business"
            element={<News key="business" apikey={Apikey} category="business" />}
          />
          <Route
            path="/entertainment"
            element={<News key="entertainment" apikey={Apikey} category="entertainment" />}
          />
          <Route
            path="/sports"
            element={<News key="sports" apikey={Apikey} category="sports" />}
          />
          <Route
            path="/health"
            element={<News key="health" apikey={Apikey} category="health" />}
          />
          <Route
            path="/science"
            element={<News key="science" apikey={Apikey} category="science" />}
          />
          <Route
            path="/technology"
            element={<News key="technology" apikey={Apikey} category="technology" />}
          />
        </Routes>
        </div>
      </div>
